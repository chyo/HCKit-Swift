...
public class HCRefreshHeaderView: UIView, HCPullToRefreshViewProtocol {
    ...
    public override func draw(_ rect: CGRect) {
        ...
        self.doneShapeLayer?.frame = CGRect.init(x: (rect.size.width-shapeSize.width)/2, y: (rect.size.height-shapeSize.height)/2, width: shapeSize.width, height: shapeSize.height)
